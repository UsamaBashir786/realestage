...
<head>
  <meta charset="utf-8">
  <title>NewVilla - Services Details</title>
                    ...
                    <div class="col-lg-8">
                        <div class="services__details--wrapper">
                            <div class="services__details--thumbnail mb-30">
                                <img src="assets/img/other/services-details.jpg" alt="img">
                            </div>
                            <div class="services__details--content">
                                <div class="services__details--content__step mb-30">
                                    <h2 class="services__details--title">DIGITAL MARKETING</h2>
                                    <p class="services__details--desc">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Placeat qui ducimus illum modi?  perspiciatis
                                ...
                                <div class="services__details--info mb-40 d-flex">
                                    <div class="services__details--info__thumbnail position-relative">
                                        <img src="assets/img/other/services-details2.jpg" alt="img">
                                    ...
                                    <div class="services__details--info__content">
                                        <h3 class="services__details--info__title">Why Marketing Important ?</h3>
                                ...
                                <div class="widget__timing--inner">
                                    <ul class="widget__timing--wrapper">
                                        <li class="widget__timing--list d-flex justify-content-between">
                                            ...
                                            <span class="widget__timing--text">9.00 - 20.00</span>
                                        </li>
                                        <li class="widget__timing--list d-flex justify-content-between">
                                            <span class="widget__timing--text">Saturday </span>
                                            <span class="widget__timing--text"> 10.00 - 16.00</span>
                                        </li>
                                        <li class="widget__timing--list d-flex justify-content-between">
                                            <span class="widget__timing--text">Sunday</span>
                                            <span class="widget__timing--text"> 9.30 - 18.00</span>
                                        </li>
                                    </ul>
                            ...
                            <div class="services__widget--step">
                                ...
                                <div class="widget__img--gallery">
                                    <div class="widget__img--gallery__thumbnail mb-20">
                                        <img src="assets/img/other/widget-img-gallery.png" alt="img">
                                    </div>
                                    <div class="widget__img--gallery__content">
                                        <h3 class="widget__img--gallery__title">Dental Bridges</h3>
