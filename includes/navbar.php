      ...
      <div class="main__header d-flex justify-content-between align-items-center">
        ...
        <div class="main__menu d-none d-lg-block">
          <nav class="main__menu--navigation">
            <ul class="main__menu--wrapper d-flex">
              ...
              <li class="main__menu--items">
                <a class="main__menu--link" href="blog.php">News</a>
              </li>
              <li class="main__menu--items">
                <a class="main__menu--link" href="#"> More </a>
                <svg class="menu__arrowdown--icon" xmlns="http://www.w3.org/2000/svg" width="10" height="7" viewBox="0 0 12 7.41">
                  <path d="M16.59,8.59,12,13.17,7.41,8.59,6,10l6,6,6-6Z" transform="translate(-6 -8.59)" fill="currentColor" opacity="0.7" />
                </svg>
                <ul class="sub__menu">
                  <li class="sub__menu--items"><a href="about.php">About Us</a></li>
                  <li class="sub__menu--items"><a href="contact.php">Contact Us</a></li>
                  <li class="sub__menu--items"><a href="project.php">Project</a></li>
                  <li class="sub__menu--items"><a href="services-details.php">Services Details</a></li>
                  <li class="sub__menu--items"><a href="404.php">Error 404</a></li>
                </ul>
              </li>
            </ul>
          </nav>
        ...
        <div class="main__header--right d-flex align-items-center">
          <?php if (isset($_SESSION['user_id'])): ?>
            ...
            <a class="add__listing--btn solid__btn login__register--link" href="user/index.php">
            ...
            <!-- Logout Button -->
            <a class="add__listing--btn solid__btn login__register--link" href="logout.php">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-log-out">
                <path d="M9 21h6a2 2 0 0 0 2-2V5a2 2 0 0 0-2-2H9"></path>
          ...
          <?php else: ?>
            ...
            <a class="add__listing--btn solid__btn login__register--link" href="login.php">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-users">
                <path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path>
                <circle cx="9" cy="7" r="4"></circle>
                <path d="M23 21v-2a4 4 0 0 0-3-3.87"></path>
    ...
    <div class="sidebar__gallery">
      ...
      <ul class="sidebar__gallery--wrapper d-flex">
        <li class="sidebar__gallery--items">
          <a class="sidebar__gallery--link" href="listing.php"><img class="sidebar__gallery--img" src="assets/img/gallery/gallery1.png" alt="gallery"></a>
          <span class="sidebar__gallery--subtitle">Properties</span>
        </li>
        <li class="sidebar__gallery--items">
          <a class="sidebar__gallery--link" href="listing.php"><img class="sidebar__gallery--img" src="assets/img/gallery/gallery2.png" alt="gallery"></a>
          <span class="sidebar__gallery--subtitle">Services</span>
        </li>
        <li class="sidebar__gallery--items">
          <a class="sidebar__gallery--link" href="listing.php"><img class="sidebar__gallery--img" src="assets/img/gallery/gallery3.png" alt="gallery"></a>
          <span class="sidebar__gallery--subtitle">House</span>
        </li>
        <li class="sidebar__gallery--items">
          <a class="sidebar__gallery--link" href="listing.php"><img class="sidebar__gallery--img" src="assets/img/gallery/gallery4.png" alt="gallery"></a>
          <span class="sidebar__gallery--subtitle">Villa</span>
        </li>
        <li class="sidebar__gallery--items">
          <a class="sidebar__gallery--link" href="listing.php"><img class="sidebar__gallery--img" src="assets/img/gallery/gallery5.png" alt="gallery"></a>
