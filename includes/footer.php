                            ...
                            <div class="footer__widget">
                                ...
                                <div class="footer__widget--inner">
                                    <div class="footer__logo">
                                        <a class="footer__logo--link display-block" href="index.php">
                        ...
                        <div class="col-xl-2 col-lg-3 col-md-3">
                            <div class="footer__widget">
                                ...
                                <ul class="footer__widget--menu footer__widget--inner">
                                    <li class="footer__widget--menu__list"><a class="footer__widget--menu__text" href="listing.php">Property on sale</a></li>
                                    <li class="footer__widget--menu__list"><a class="footer__widget--menu__text" href="listing.php">Team membar</a></li>
                                    <li class="footer__widget--menu__list"><a class="footer__widget--menu__text" href="listing.php">Offices for Buy</a></li>
                                    <li class="footer__widget--menu__list"><a class="footer__widget--menu__text" href="listing.php">Terms of use</a></li>
                                    <li class="footer__widget--menu__list"><a class="footer__widget--menu__text" href="listing.php">Offices for Rent</a></li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-xl-2 col-lg-3 col-md-3">
                            <div class="footer__widget">
                                ...
                                <ul class="footer__widget--menu footer__widget--inner">
                                    ...
                                    <li class="footer__widget--menu__list"><a class="footer__widget--menu__text" href="listing.php">Propert owners</a></li>
                                    <li class="footer__widget--menu__list"><a class="footer__widget--menu__text" href="admin/create-listing.php">Contact Support</a></li>
                                    <li class="footer__widget--menu__list"><a class="footer__widget--menu__text" href="listing.php">Pricing Plans</a></li>
                                    <li class="footer__widget--menu__list"><a class="footer__widget--menu__text" href="listing.php">Partners</a></li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-xl-2 col-lg-3 col-md-3">
