                ...
                <div class="categories__inner row mb--n30">
                    <div class="col-lg-4 col-md-6 col-sm-6 mb-30" data-aos="fade-up" data-aos-duration="1200" data-aos-delay="100">
                        <div class="categories__box">
                            ...
                            <div class="categories__content text-center">
                                <h3 class="categories__title"><a href="listing-details.php">Single-family home</a></h3>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 mb-30" data-aos="fade-up" data-aos-duration="1200" data-aos-delay="150">
                        <div class="categories__box">
                            ...
                            <div class="categories__content text-center">
                                <h3 class="categories__title"><a href="listing-details.php">Duplex - Houses</a></h3>
                                <p class="categories__desc">With over 1 million+ homes for sale available
                                    on the website, Trulia can match you with
                                    a house you will want to call home.</p>
                                <a class="categories__link" href="listing-details.php">See Properites <svg width="33" height="19" viewBox="0 0 33 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 mb-30" data-aos="fade-up" data-aos-duration="1200" data-aos-delay="200">
                        <div class="categories__box">
                            ...
                            <div class="categories__content text-center">
                                <h3 class="categories__title"><a href="listing-details.php">Container Home</a></h3>
                                <p class="categories__desc">With over 1 million+ homes for sale available
                                    on the website, Trulia can match you with
                                    a house you will want to call home.</p>
                                <a class="categories__link" href="listing-details.php">See Properites <svg width="33" height="19" viewBox="0 0 33 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="popular__featured--column5 swiper">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <article class="popular__featured--card">
                                    <div class="popular__featured--thumbnail position-relative">
                                        <a class="popular__featured--link"  href="listing-details.php"><img class="popular__featured--img" src="assets/img/property/popular-properties1.png" alt="popular-properties"></a>
                            ...
                            <div class="swiper-slide">
                                <article class="popular__featured--card">
                                    <div class="popular__featured--thumbnail position-relative">
                                        <a class="popular__featured--link"  href="listing-details.php"><img class="popular__featured--img" src="assets/img/property/popular-properties2.png" alt="popular-properties"></a>
                                        <span class="popular__featured--badge">13</span>
                                        <div class="popular__featured--content">
                            ...
                            <div class="swiper-slide">
                                <article class="popular__featured--card">
                                    <div class="popular__featured--thumbnail position-relative">
                                        <a class="popular__featured--link"  href="listing-details.php"><img class="popular__featured--img" src="assets/img/property/popular-properties3.png" alt="popular-properties"></a>
                                        <span class="popular__featured--badge">13</span>
                                        <div class="popular__featured--content">
                            ...
                            <div class="swiper-slide">
                                <article class="popular__featured--card">
                                    <div class="popular__featured--thumbnail position-relative">
                                        <a class="popular__featured--link"  href="listing-details.php"><img class="popular__featured--img" src="assets/img/property/popular-properties4.png" alt="popular-properties"></a>
                                        <span class="popular__featured--badge">13</span>
                                        <div class="popular__featured--content">
                            ...
                            <div class="swiper-slide">
                                <article class="popular__featured--card">
                                    <div class="popular__featured--thumbnail position-relative">
                                        <a class="popular__featured--link"  href="listing-details.php"><img class="popular__featured--img" src="assets/img/property/popular-properties5.png" alt="popular-properties"></a>
                                        <span class="popular__featured--badge">13</span>
                                        <div class="popular__featured--content">
