...
<head>
  <meta charset="utf-8">
  <title>NewVilla - Project Page</title>
            ...
            <div class="container">
                <div class="row mb--n40">
                    ...
                    <div class="col-lg-6 col-md-6 mb-40" data-aos="fade-up" data-aos-duration="1200" data-aos-delay="100">
                        <div class="project__items">
                            <div class="project__thumbnail">
                                <a class="project__thumbnail--link" href="project-details.php"><img class="project__thumbnail--media" src="assets/img/property/project2.jpg" alt="project-img"></a>
                            </div>
                            <div class="project__content">
                                <span class="project__content--meta__tag">Marketing</span>
                                <h3 class="project__content--title"><a href="project-details.php">Research beyond plan</a></h3>
                                <a class="project__content--link" href="project-details.php">View Projects <svg width="17" height="7" viewBox="0 0 17 7" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M15.9227 3.10264L12.6345 0.163758C12.5807 0.112601 12.5128 0.071331 12.4358 0.0430016C12.3588 0.0146722 12.2745 0 12.1892 0C12.1039 0 12.0197 0.0146722 11.9426 0.0430016C11.8656 0.071331 11.7977 0.112601 11.7439 0.163758C11.625 0.276582 11.5601 0.417625 11.5601 0.563112C11.5601 0.708598 11.625 0.849607 11.7439 0.962432L13.9509 2.93537H0.62744C0.452746 2.95613 0.293442 3.0245 0.178355 3.12813C0.0632677 3.23176 0 3.3638 0 3.50034C0 3.63688 0.0632677 3.76888 0.178355 3.87251C0.293442 3.97614 0.452746 4.04455 0.62744 4.06531H13.9538L11.7468 6.03821C11.6277 6.15095 11.5626 6.29202 11.5626 6.43756C11.5626 6.58311 11.6277 6.72418 11.7468 6.83692C11.8006 6.88788 11.8684 6.92896 11.9453 6.95717C12.0222 6.98537 12.1062 7 12.1914 7C12.2765 7 12.3605 6.98537 12.4374 6.95717C12.5143 6.92896 12.5821 6.88788 12.6359 6.83692L15.9241 3.89804C16.0417 3.78535 16.1057 3.64489 16.1055 3.50014C16.1052 3.35538 16.0407 3.21508 15.9227 3.10264Z" fill="currentColor"/>
                                    </svg>
                                </a>
                    ...
                    <div class="col-lg-6 col-md-6 mb-40" data-aos="fade-up" data-aos-duration="1200" data-aos-delay="150">
                        <div class="project__items">
                            <div class="project__thumbnail">
                                <a class="project__thumbnail--link" href="project-details.php"><img class="project__thumbnail--media" src="assets/img/property/project3.jpg" alt="project-img"></a>
                            </div>
                            <div class="project__content">
                                <span class="project__content--meta__tag">Marketing</span>
                                <h3 class="project__content--title"><a href="project-details.php">Upcoming New Projects</a></h3>
                                <a class="project__content--link" href="project-details.php">View Projects <svg width="17" height="7" viewBox="0 0 17 7" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M15.9227 3.10264L12.6345 0.163758C12.5807 0.112601 12.5128 0.071331 12.4358 0.0430016C12.3588 0.0146722 12.2745 0 12.1892 0C12.1039 0 12.0197 0.0146722 11.9426 0.0430016C11.8656 0.071331 11.7977 0.112601 11.7439 0.163758C11.625 0.276582 11.5601 0.417625 11.5601 0.563112C11.5601 0.708598 11.625 0.849607 11.7439 0.962432L13.9509 2.93537H0.62744C0.452746 2.95613 0.293442 3.0245 0.178355 3.12813C0.0632677 3.23176 0 3.3638 0 3.50034C0 3.63688 0.0632677 3.76888 0.178355 3.87251C0.293442 3.97614 0.452746 4.04455 0.62744 4.06531H13.9538L11.7468 6.03821C11.6277 6.15095 11.5626 6.29202 11.5626 6.43756C11.5626 6.58311 11.6277 6.72418 11.7468 6.83692C11.8006 6.88788 11.8684 6.92896 11.9453 6.95717C12.0222 6.98537 12.1062 7 12.1914 7C12.2765 7 12.3605 6.98537 12.4374 6.95717C12.5143 6.92896 12.5821 6.88788 12.6359 6.83692L15.9241 3.89804C16.0417 3.78535 16.1057 3.64489 16.1055 3.50014C16.1052 3.35538 16.0407 3.21508 15.9227 3.10264Z" fill="currentColor"/>
                                    </svg>
                                </a>
                    ...
                    <div class="col-lg-6 col-md-6 mb-40" data-aos="fade-up" data-aos-duration="1200" data-aos-delay="200">
                        <div class="project__items">
                            <div class="project__thumbnail">
                                <a class="project__thumbnail--link" href="project-details.php"><img class="project__thumbnail--media" src="assets/img/property/project4.jpg" alt="project-img"></a>
                            </div>
                            <div class="project__content">
                                <span class="project__content--meta__tag">Marketing</span>
                                <h3 class="project__content--title"><a href="project-details.php">Js Developer Required</a></h3>
                                <a class="project__content--link" href="project-details.php">View Projects <svg width="17" height="7" viewBox="0 0 17 7" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M15.9227 3.10264L12.6345 0.163758C12.5807 0.112601 12.5128 0.071331 12.4358 0.0430016C12.3588 0.0146722 12.2745 0 12.1892 0C12.1039 0 12.0197 0.0146722 11.9426 0.0430016C11.8656 0.071331 11.7977 0.112601 11.7439 0.163758C11.625 0.276582 11.5601 0.417625 11.5601 0.563112C11.5601 0.708598 11.625 0.849607 11.7439 0.962432L13.9509 2.93537H0.62744C0.452746 2.95613 0.293442 3.0245 0.178355 3.12813C0.0632677 3.23176 0 3.3638 0 3.50034C0 3.63688 0.0632677 3.76888 0.178355 3.87251C0.293442 3.97614 0.452746 4.04455 0.62744 4.06531H13.9538L11.7468 6.03821C11.6277 6.15095 11.5626 6.29202 11.5626 6.43756C11.5626 6.58311 11.6277 6.72418 11.7468 6.83692C11.8006 6.88788 11.8684 6.92896 11.9453 6.95717C12.0222 6.98537 12.1062 7 12.1914 7C12.2765 7 12.3605 6.98537 12.4374 6.95717C12.5143 6.92896 12.5821 6.88788 12.6359 6.83692L15.9241 3.89804C16.0417 3.78535 16.1057 3.64489 16.1055 3.50014C16.1052 3.35538 16.0407 3.21508 15.9227 3.10264Z" fill="currentColor"/>
                                    </svg>
                                </a>
